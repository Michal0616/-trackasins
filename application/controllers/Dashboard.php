    ...
    public function SaveToDB()
    {
        ...
        if(isset($planItems)) {
            if($planItems['plan_count'] > $planItems['current_count'] && $planItems['result'] =='success'){
                ...
                $amazonstock = $this->input->post('amazonstock');
...
//            $asinsManagementSystem->getAsinsFromNumber($asin);
    ...
    protected function onGetDataTableContentRow($scrapeEntry)
    {
        ...
        if ($scrapeEntry->tracking == 1 || $scrapeEntry->stock_noti == 'true' || $scrapeEntry->stock_noti == 1) {
            if (($scrapeEntry->amznotseller == "2") && ($scrapeEntry->sellerstock == "1")) {
                $row_html .= '<div class="green-right-triangle"></div>';
            } else if (($scrapeEntry->amznotseller == "2") && ($scrapeEntry->sellerstock == "0")) {
        ...
        if ($scrapeEntry->stock_noti != 1 && $scrapeEntry->stock_noti != "true" && $scrapeEntry->tracking != "1") {
        ...
        } else if (($scrapeEntry->stock_noti == 1 || $scrapeEntry->stock_noti == "true") && $scrapeEntry->tracking == "1" && $scrapeEntry->status == 6 ) {
            $row_html .= '<!--start SELLERSTOCK-->
            <td class="text-center b red verticle-middle">
                <span style="color:#aaa; font-size:14px;" id="stock_label_'.$scrapeEntry->id.'">Item no longer exists <br>on Amazon</span>
            </td>
            <!--END SELLERSTOCK-->

            <!--start AMZNOTSELLER-->
            <td class="text-center b red verticle-middle">
                <span style="color:#aaa; font-size:14px;" id="amznotseller_label_'.$scrapeEntry->id.'">Item no longer exists<br> on Amazon</span>
            </td>';
        } else {
            /* ----------------------------------------------------------------------------------*/
            ...
            } else if (($scrapeEntry->sellerstock == "0")){
                if (($scrapeEntry->amznotseller == "2")) {
                    $row_html .=' <td class="text-center b red verticle-middle" id="stock_label_'. $scrapeEntry->id . '">
            ...
            if (($scrapeEntry->sellerstock == "0")) {
                if (($scrapeEntry->amznotseller == "2")) {
                    $row_html .='<td class="text-center b red verticle-middle">
                                    <span style="color:red; font-size:25px;" id="amznotseller_label_'. $scrapeEntry->id . '">No!</span>
                                </td>';
                }else{
                    $row_html .='<td class="text-center b red verticle-middle">
                                    <span style="color:black; font-size:25px;" id="amznotseller_label_'.$scrapeEntry->id.'">No</span>
                                </td>';
                }
            }      
            
            if (($scrapeEntry->sellerstock == "1")) {
                if (($scrapeEntry->amznotseller == "2")) {
                    $row_html .='<td class="text-center b red verticle-middle">
                                    <span style="color:black; font-size:25px;" id="amznotseller_label_'.$scrapeEntry->id.'">Yes</span>
                                </td>';
                }else{
